...
The library was primarily written in Python 3. It can be broken down as such
...
The training models were created using TensorFlow 2.0 with the keras functional API.
