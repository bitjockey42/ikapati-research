...
\begin{figure}[h!]
  ...
  \end{subfigure}
  \caption{InceptionV3, truncated representation.}
  \label{fig:benchmark}
\end{figure}
...
The benchmark model achieved an accuracy of 85.68\% on the test dataset, and a loss score of 0.570. 
...
Model performance was evaluated with accuracy and loss scores for both cross-validation during training and for evaluating performance on the test set.
