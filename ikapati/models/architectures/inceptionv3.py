...
def model(num_classes, input_shape=None, learning_rate=0.1, activation="linear", padding="same", channels=3, dropout=None):
    """
    This is a convolutional neural network based on the InceptionV3-based architecture described here:
     - https://spj.sciencemag.org/plantphenomics/2019/9237136/

    Code based on https://github.com/keras-team/keras-applications/blob/master/keras_applications/inception_v3.py
    """
